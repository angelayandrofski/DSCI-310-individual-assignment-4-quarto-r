...
\caption{\label{tbl-horse-sd}Standard Deviation of Horse Populations for
...
span as Figure~\ref{fig-horse-pop}.

\begin{figure}

\centering{

\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{../results/horse_pop_plot_largest_sd.png}

}

\caption{\label{fig-pop-sd}Horse populations for the province with the
largest standard deviation}

\end{figure}%

In Figure~\ref{fig-pop-sd} we zoom in and look at the province of
